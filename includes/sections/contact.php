<!-- Contact Section - Premium Responsive Design -->
                    ...
                    <div class="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 xl:gap-16">
                        ...
                        <div class="order-2 lg:order-1">
                            ...
                            <div class="space-y-3 sm:space-y-4">
                                <a href="https://wa.me/6281234567890" class="group flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-5 bg-gradient-to-br from-white/[0.06] to-transparent border border-white/[0.08] rounded-xl sm:rounded-2xl cursor-pointer hover:border-primary/30 transition-all duration-300">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-gray-500 text-xs sm:text-sm truncate">+62 812 3456 7890</p>
                                    </div>
                                ...
                                <a href="mailto:hello@homeputra.com" class="group flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-5 bg-gradient-to-br from-white/[0.06] to-transparent border border-white/[0.08] rounded-xl sm:rounded-2xl cursor-pointer hover:border-primary/30 transition-all duration-300">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-gray-500 text-xs sm:text-sm truncate">hello@homeputra.com</p>
                                    </div>
                                    <span class="material-symbols-outlined text-gray-600 text-lg sm:text-xl group-hover:text-primary group-hover:translate-x-1 transition-all flex-shrink-0">arrow_forward</span>
                                </a>
                                ...
                                <div class="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 md:p-5 bg-gradient-to-br from-white/[0.06] to-transparent border border-white/[0.08] rounded-xl sm:rounded-2xl">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-gray-500 text-xs sm:text-sm">Surabaya, Jawa Timur</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="mt-6 sm:mt-8 md:mt-10">
                                ...
                                <div class="flex items-center gap-2 sm:gap-3">
                                    <a href="#" class="w-9 sm:w-10 md:w-11 h-9 sm:h-10 md:h-11 rounded-lg sm:rounded-xl bg-white/[0.05] border border-white/[0.08] flex items-center justify-center text-gray-400 hover:text-primary hover:border-primary/30 hover:scale-110 transition-all">
